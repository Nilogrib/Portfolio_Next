            ...
            <div className="w-full md:col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                ...
                <div className="flex flex-row p-6">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-lg text-white/70 mt-2">Currently pursuing BTech in IT at IIIT Bhopal, focusing on technologies like React, Next.js and Tailwind CSS</p>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                <div className="flex flex-row p-6">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-lg text-white/70 mt-2">I specialize in C++, Java, Python, HTML, Javascript & several frameworks</p>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                <div className="flex flex-row p-6">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-lg text-white/70 mt-2">I have worked on projects ranging from fullstack web to robust AI/ML applications</p>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                <div className="flex flex-row p-6">
                    ...
                    <div className="flex flex-col mt-4">
                        ...
                        <p className="text-lg text-white/70 mt-2">5⭐ on CodeChef, Expert on Codeforces, Knight on LeetCode with 1500+ problems solved across all platforms</p>
                    </div>
                </div>
            </div>
